...
function vanillaSelectBox(domSelector, options) {
    let childClassName = 'a'
    if (typeof document.querySelector(domSelector).options[0] != 'undefined') {
        childClassName = document.querySelector(domSelector).options[0].classList[0]
    }
    ...
    this.getCssArray = function (selector) {
        ...
        if (selector === ".vsb-main button") {
            cssArray = [
                ...
                { "key": "border", "value": "1px solid transparent !important" },
    ...
    this.createTree = function () {
        ...
        if (this.isMultiple) {
            ...
            if (!self.userOptions.disableSelectAll) {
                ...
                selectAll.classList.add(self.childClassName);
        ...
        if (self.userOptions.stayOpen) {
            ...
            this.main.addEventListener("click", function (e) {
                ...
                console.log("close ")
                console.log("self.getResult() ", self.getResult())
