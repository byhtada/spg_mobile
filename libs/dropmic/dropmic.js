export default class Dropmic {
    ...
    constructor(target, options) {
        ...
        //console.log("Dropmic create ", target.id)
        this.init();
    ...
    _bindEvents() {
        ...
        this.btn.addEventListener("click", (event) => {
            ...
            if (!this.target.classList.contains(this.showClass)) {
                ...
                //console.log("Dropmic close classical")
                this.close();
            }
        });
        ...
        document.addEventListener("click", (event) => {
            if (!(this._findAncestor(event.target, 'dropmic') === this.target)) {
                if (this.target.classList.contains(this.showClass)) {
                    //console.log("Dropmic close outside menu")
    ...
    */
    ...
    // Close dropdown
    close() {
        //console.log("Dropmic close ", this)
        this._beforeClose();
